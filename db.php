<?php
    ...
    // $aircraft_sql = "CREATE TABLE Aircraft (id int NOT NULL AUTO_INCREMENT, uuid char(36) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL, aircraftName varchar(255) DEFAULT NULL,from_ varchar(255) DEFAULT NULL, to_ varchar(255) DEFAULT NULL, seatingCapacity varchar(255) DEFAULT NULL, createdAt datetime NOT NULL, updatedAt datetime NOT NULL, AirlineId int NOT NULL,travelHours varchar(45) DEFAULT NULL,departureDateTime datetime DEFAULT NULL,ArrivalDateTime datetime DEFAULT NULL,price varchar(45) DEFAULT NULL,PRIMARY KEY (id),UNIQUE KEY uuid (uuid),KEY AirlineId (AirlineId),CONSTRAINT Aircraft_ibfk_1 FOREIGN KEY (AirlineId) REFERENCES Airline (id) ON DELETE CASCADE ON UPDATE CASCADE )";
